...
if (isset($_POST['submit'])) {
	...
	$insertquery = "INSERT INTO residents( first_name,last_name,contact,age) VALUES( '$first_name','$last_name', '$contact', '$age')";
...
.modal-content {
  ...
  box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2);
  width: 50%;
  max-height: 90%; /* Limit the maximum height of the modal content */
